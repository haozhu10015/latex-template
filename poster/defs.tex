% \largetext  % uncomment to show main text in '\large'
% \TPshowboxestrue  % uncomment to show box around text block
...
\newcommand{\cvxset}{{\cal C{}}}  % convex set
\newcommand{\idxset}{{\cal F{}}}  % index set
\newcommand{\Dkl}{\mathop{D_{\rm kl}}}  % KL-divergence
